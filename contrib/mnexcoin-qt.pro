...
RESOURCES += src/qt/mnexcoin.qrc src/qt/mnexcoin_locale.qrc

TRANSLATIONS += src/qt/locale/mnexcoin_bg.ts \
                src/qt/locale/mnexcoin_de.ts \
                src/qt/locale/mnexcoin_en.ts \
                src/qt/locale/mnexcoin_es.ts \
                src/qt/locale/mnexcoin_fi.ts \
                src/qt/locale/mnexcoin_fr.ts \
                src/qt/locale/mnexcoin_it.ts \
                src/qt/locale/mnexcoin_ja.ts \
                src/qt/locale/mnexcoin_pl.ts \
                src/qt/locale/mnexcoin_pt.ts \
                src/qt/locale/mnexcoin_ru.ts \
                src/qt/locale/mnexcoin_sk.ts \
                src/qt/locale/mnexcoin_sv.ts \
                src/qt/locale/mnexcoin_vi.ts \
                src/qt/locale/mnexcoin_zh_CN.ts \
                src/qt/locale/mnexcoin_zh_TW.ts
