Contributing to MNEXcoin Core
============================

The MNEXcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the MNEXcoin Core project, and is not to be
confused with overall MNEXcoin Network Protocol consensus changes.

Whether a pull request is merged into MNEXcoin Core rests with the project merge
...
Patches that change MNEXcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the MNEXcoin consensus, it must have been
...
The project leader is the release manager for each MNEXcoin Core release.
