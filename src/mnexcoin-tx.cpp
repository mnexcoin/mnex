...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("mnexcoin Core mnexcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  mnexcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mnexcoin transaction") + "\n" +
                               "  mnexcoin-tx [options] -create [commands]   " + _("Create hex-encoded mnexcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mnexcoin transaction
