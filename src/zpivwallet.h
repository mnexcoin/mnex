...
#ifndef MNEXcoin_ZMNEXWALLET_H
#define MNEXcoin_ZMNEXWALLET_H
...
public:
    CzMNEXWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZMNEX(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZMNEX(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //MNEXcoin_ZMNEXWALLET_H
