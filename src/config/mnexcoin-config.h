/* src/config/mnexcoin-config.h.  Generated from mnexcoin-config.h.in by configure.  */
/* src/config/mnexcoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef MNEX_CONFIG_H

#define MNEX_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.mnexcoin.cc"

/* Define to the full name of this package. */
#define PACKAGE_NAME "mnexcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "mnexcoin Core 1.0.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "mnexcoin"
