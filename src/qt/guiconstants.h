...
/* mnexcoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "MNEXcoin"
#define QAPP_ORG_DOMAIN "mnexcoin.cc"
#define QAPP_APP_NAME_DEFAULT "MNEXcoin-Qt"
#define QAPP_APP_NAME_TESTNET "MNEXcoin-Qt-testnet"
