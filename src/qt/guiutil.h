...
/** Utility functions used by the MNEXcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render MNEXcoin addresses in monospace font
...
// Parse "mnexcoin:" URI into recipient object, return true on successful parsing
