                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("MNEXcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MNEXcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mnexcoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zMNEX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MNEXcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about MNEXcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MNEXcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MNEXcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MNEXcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a MNEXcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MNEXcoin Core help message to get a list with possible MNEXcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MNEXcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MNEXcoin network", "", count));
}
...
{
    QString strTitle = tr("MNEXcoin Core"); // default title
