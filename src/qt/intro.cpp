...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("MNEXcoin Core"),
     ...
     * override -datadir in the mnexcoin.conf file in the default data directory
     * (to be consistent with mnexcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
