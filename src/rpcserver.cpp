...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop MNEXcoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "MNEXcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MNEXcoin features */
        {"mnexcoin", "masternode", &masternode, true, true, false},
        {"mnexcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"mnexcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"mnexcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"mnexcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"mnexcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"mnexcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"mnexcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"mnexcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"mnexcoin", "startmasternode", &startmasternode, true, true, false},
        {"mnexcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"mnexcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"mnexcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"mnexcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"mnexcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"mnexcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"mnexcoin", "mnbudget", &mnbudget, true, true, false},
        {"mnexcoin", "preparebudget", &preparebudget, true, true, false},
        {"mnexcoin", "submitbudget", &submitbudget, true, true, false},
        {"mnexcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"mnexcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"mnexcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"mnexcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"mnexcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"mnexcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"mnexcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"mnexcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"mnexcoin", "mnsync", &mnsync, true, true, false},
        {"mnexcoin", "spork", &spork, true, true, false},
        {"mnexcoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> mnexcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:32574/\n";
}
