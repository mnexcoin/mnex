...
#ifndef MNEXcoin_STAKEINPUT_H
#define MNEXcoin_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZMNEX() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zMNEXStake can take two forms
...
public:
    ...
    bool IsZMNEX() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZMNEX() override { return false; }
};


#endif //MNEXcoin_STAKEINPUT_H
