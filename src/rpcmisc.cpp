...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total mnexcoin balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"zMNEXsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zMNEX denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zMNEX denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zMNEX denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zMNEX denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zMNEX denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zMNEX denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zMNEX denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zMNEX denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zMNEX denominations\n"
            "  }\n"
            "  \"keypoololdest\": xxxxxx,    (numeric) the timestamp (seconds since GMT epoch) of the oldest pre-generated key in the key pool\n"
            "  \"keypoolsize\": xxxx,        (numeric) how many new keys are pre-generated\n"
            "  \"unlocked_until\": ttt,      (numeric) the timestamp in seconds since epoch (midnight Jan 1 1970 GMT) that the wallet is unlocked for transfers, or 0 if the wallet is locked\n"
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in mnexcoin/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in mnexcoin/kb\n"
    ...
    obj.push_back(Pair("zMNEXsupply", zpivObj));
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"mnexcoinaddress\"\n"
            "\nReturn information about the given mnexcoin address.\n"

            "\nArguments:\n"
            "1. \"mnexcoinaddress\"     (string, required) The mnexcoin address to validate\n"

            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"mnexcoinaddress\", (string) The mnexcoin address validated\n"
...
#ifdef ENABLE_WALLET
        // Case 1: MNEXcoin address and we have full public key:
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
        throw runtime_error(
            ...
            "2. \"keys\"       (string, required) A json array of keys which are mnexcoin addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) mnexcoin address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"mnexcoinaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"

            "\nArguments:\n"
            "1. \"mnexcoinaddress\"  (string, required) The mnexcoin address to use for the signature.\n"
