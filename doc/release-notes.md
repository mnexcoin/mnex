MNEXcoin Core version *3.1.1* is now available from:  <https://github.com/mnexcoin-project/mnexcoin/releases>
...
Please report bugs using the issue tracker at github: <https://github.com/mnexcoin-project/mnexcoin/issues>

Non-Mandatory Update
==============

MNEXcoin Core v3.1.1 is a non-mandatory update to address bugs and introduce minor enhancements that do not require a network change.
...
### Fix spending for v1 zMNEX created before block 1050020

The transition to v2 zMNEX and reset of the accumulators caused blocks 1050000 - 1050010 to be accumulated twice. This was causing a number v1 zMNEX to not create valid witnesses, and thus were not spendable. This problem is fixed by double accumulating blocks 1050000-1050010 when creating the witness. Any user that had issues spending zMNEX v1 will now be able to convert that into MNEX and then zMNEX v2 (if desired).

### Adjustment to staking properties to reduce orphaned blocks

zMNEX stake set to update more frequently and lowering the stake hashdrift to 30 seconds to reduce the number of orphans being experienced by MNEXcoin stakers.
...
MNEXcoin Daemon & Client (RPC Changes)
--------------
...
### Core Features
 ...
 - #609 `6b73598b9` [MoveOnly] Remove zMNEX code from main.cpp (presstab)
...
### GUI
 ...
 - #600 `217433561` [GUI] Only enable/disable PrivacyDialog zMNEX elements if needed. (presstab)
...
### Wallet
 ...
 - #603 `779d8d597` Fix spending for v1 zMNEX created before block 1050020. (presstab)
