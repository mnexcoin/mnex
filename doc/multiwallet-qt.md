...
In order to support loading of multiple wallets in mnexcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mnexcoin.cpp.
...
Changes to mnexcoin.cpp
----------------------
mnexcoin.cpp is the entry point into mnexcoin-qt, and as such, will require some minor modifications to provide hooks for
