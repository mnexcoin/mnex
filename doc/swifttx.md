...
This mechanism has been integrated into Bitcore-Node-MNEXcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/MNEXcoin-Project/insight-api-mnexcoin#web-socket-api](https://github.com/MNEXcoin-Project/insight-api-mnexcoin#web-socket-api) 
* API: [https://github.com/MNEXcoin-Project/insight-api-mnexcoin#swifttx-transactions](https://github.com/MNEXcoin-Project/insight-api-mnexcoin#swifttx-transactions) 
...
By default, the MNEXcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the MNEXcoin Core daemon:
